...
#########################################################--Run-02----#############################################################
#3) start the run
    run = mlflow.start_run(run_name="run_1",experiment_id=exp.experiment_id)
...
#get active run detail
    ...
    #get details from run object
    # print("The experiment id is   : {}".format(run.info.experiment_id))
    print("--The Recent run id is   : {}".format(run.info.run_id))
    print("--The Recent run name is : {}".format(run.info.run_name))
